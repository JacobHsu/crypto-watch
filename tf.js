...
function initializeCharts() {
  ...
  setTimeout(() => createChart(`tradingview_${prefix}_col1`, symbol, interval, indicatorSets.column1, false), 100);
  setTimeout(() => createChart(`tradingview_${prefix}_col2`, symbol, interval, indicatorSets.column2, false), 200);
  setTimeout(() => createChart(`tradingview_${prefix}_col3`, symbol, interval, indicatorSets.column3, true),  300);
  setTimeout(() => createChart(`tradingview_${prefix}_col4`, symbol, interval, indicatorSets.column4, false), 400);
}
